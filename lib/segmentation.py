...
class Segmentation:
    def segment_cloud(self,cloud, search_radius=0.005,min_cluster_size=100,max_cluster_size=10000000):
        """
        ...
        for i in objects_ids:
            ...
            if len(object_idxs[0]) < min_cluster_size or len(object_idxs[0]) > max_cluster_size:
